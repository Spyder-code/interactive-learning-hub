...
export const slidesP2: Slide[] = [
  {
    ...
    checklist: ["Proposal", "Makalah", "Laporan resmi"],
  ...
  },
  {
    ...
    quiz: [
      {
        question:
          "Untuk membuat halaman berbeda (misalnya cover tanpa nomor), kita butuh…",
        options: [
        ...
        explanation:
          "Section Break memisahkan dokumen menjadi bagian-bagian independen dengan pengaturan berbeda.",
      },
      {
        ...
        options: [
          ...
          {
            label: "b",
            text: "Menampilkan informasi berulang di setiap halaman",
            correct: true,
          },
          { label: "c", text: "Mengubah font dokumen" },
        ],
        explanation:
          "Header & Footer menampilkan informasi konsisten (nama, nomor halaman) di setiap halaman.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    title: "Mini Quiz",
    type: "quiz",
    icon: React.createElement(FiZap, { className: "text-warning" }),
    subtitle: "Quiz 2",
    quiz: [
      {
        ...
        explanation:
          "Header & Footer dapat ditemukan dan diatur melalui tab Insert.",
      },
      {
        ...
        explanation:
          "Opsi 'Different First Page' memungkinkan halaman pertama memiliki header/footer berbeda.",
      },
    ],
  },
  {
    ...
    title: "Section Break",
    type: "task",
    icon: React.createElement(FiScissors),
  ...
  },
  {
    ...
    type: "task",
    icon: React.createElement(FiDroplet, { className: "text-primary" }),
    subtitle: "Eksplorasi 3",
    timer: 15,
    content: ["Buat struktur dokumen berikut:"],
    tasks: ["BAB I PENDAHULUAN → Heading 1", "1.1 Latar Belakang → Heading 2"],
    requireUpload: true,
    checklist: [
      "Gunakan Heading 1",
      "Gunakan Heading 2",
  ...
  },
  {
    ...
    quiz: [
      {
        question:
          "Kenapa lebih baik pakai Styles dibanding bold manual dan perbesar font manual?",
        options: [
          {
            label: "a",
            text: "Karena Styles otomatis konsisten dan bisa digunakan untuk Daftar Isi",
            correct: true,
          },
        ...
        explanation:
          "Styles memastikan format konsisten dan memungkinkan pembuatan Daftar Isi otomatis.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    type: "challenge",
    icon: React.createElement(FiAward, { className: "text-warning" }),
    subtitle: "Tantangan",
    timer: 20,
    content: ["Buat dokumen lengkap dengan struktur:"],
    tasks: ["Halaman Cover", "Daftar Isi", "BAB I", "BAB II"],
    requireUpload: true,
    checklist: [
    ...
    quiz: [
      {
        ...
        options: [
          {
            label: "a",
            text: "Memisahkan dokumen menjadi bagian dengan pengaturan independen",
            correct: true,
          },
        ...
        explanation:
          "Section Break memisahkan dokumen agar setiap bagian bisa punya format halaman berbeda.",
      },
      {
        ...
        options: [
          ...
          {
            label: "b",
            text: "Untuk struktur dokumen dan pembuatan Daftar Isi otomatis",
            correct: true,
          },
          { label: "c", text: "Untuk mengubah warna teks" },
        ],
        explanation:
          "Heading memberi struktur dan memungkinkan Navigation Pane serta Daftar Isi otomatis.",
      },
      {
        ...
        options: [
          {
            label: "a",
            text: "Page Break hanya pindah halaman, Section Break memisahkan pengaturan format",
            correct: true,
          },
        ...
        explanation:
          "Page Break hanya memindahkan ke halaman baru, sedangkan Section Break memungkinkan pengaturan format berbeda.",
      },
    ],
  },
  {
    ...
    title: "Exit Ticket",
    type: "content",
    icon: React.createElement(FiAward, { className: "text-success" }),
    subtitle: "Penutup",
    content: [
