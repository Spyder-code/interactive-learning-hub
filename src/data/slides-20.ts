...
export const slidesP20: Slide[] = [
  ...
  {
    id: 11,
    title: "Quiz 11: Dasar LaTeX",
    type: "quiz",
    icon: "11",
    subtitle: "Bab 6 - Basic",
    content: ["Uji pemahaman tentang konsep dasar dan struktur LaTeX."],
    quiz: [
      {
        question: "Apa fungsi utama dari LaTeX?",
        options: [
          { label: "a", text: "Mengedit foto dan video" },
          {
            label: "b",
            text: "Membuat dokumen ilmiah dengan format profesional",
            correct: true,
          },
          { label: "c", text: "Membuat presentasi animasi" },
        ],
        explanation:
          "LaTeX adalah sistem persiapan dokumen untuk penulisan ilmiah berkualitas tinggi, terutama untuk dokumen dengan rumus matematika kompleks.",
      },
      {
        question:
          "Perintah untuk memulai dokumen LaTeX yang paling mendasar adalah...",
        options: [
          { label: "a", text: "\\start{document}" },
          { label: "b", text: "\\begin{document}", correct: true },
          { label: "c", text: "\\open{document}" },
        ],
        explanation:
          "\\begin{document} menandai awal konten dokumen, dan harus diakhiri dengan \\end{document}.",
      },
      {
        question: "Simbol backslash (\\) dalam LaTeX digunakan untuk...",
        options: [
          { label: "a", text: "Membuat komentar" },
          { label: "b", text: "Memulai perintah/command", correct: true },
          { label: "c", text: "Membagi paragraf" },
        ],
        explanation:
          "Backslash (\\) adalah awalan untuk semua perintah LaTeX, seperti \\textbf, \\section, dll.",
      },
      {
        question:
          "Untuk membuat teks tebal (bold) di LaTeX, perintah yang digunakan adalah...",
        options: [
          { label: "a", text: "\\textbf{teks}", correct: true },
          { label: "b", text: "\\bold{teks}" },
          { label: "c", text: "\\strong{teks}" },
        ],
        explanation:
          "\\textbf{teks} menghasilkan teks tebal. Untuk miring, gunakan \\textit{teks}.",
      },
      {
        question: "Ekstensi file standar untuk dokumen LaTeX adalah...",
        options: [
          { label: "a", text: ".latex" },
          { label: "b", text: ".tex", correct: true },
          { label: "c", text: ".ltx" },
        ],
        explanation:
          "File LaTeX disimpan dengan ekstensi .tex dan dikompilasi menjadi PDF.",
      },
    ],
  },
  {
    id: 12,
    title: "Quiz 12: LaTeX Lanjutan",
    type: "quiz",
    icon: "12",
    subtitle: "Bab 6 - Advanced",
    content: ["Uji pemahaman tentang rumus matematika dan package LaTeX."],
    quiz: [
      {
        question:
          "Untuk menulis rumus matematika dalam satu baris (inline), simbol yang digunakan adalah...",
        options: [
          { label: "a", text: "$ rumus $", correct: true },
          { label: "b", text: "# rumus #" },
          { label: "c", text: "@ rumus @" },
        ],
        explanation:
          "Rumus inline diapit tanda dolar ($x^2$), sedangkan rumus terpisah menggunakan $$rumus$$ atau environment equation.",
      },
      {
        question:
          "Perintah untuk membuat daftar bernomor (numbered list) adalah...",
        options: [
          { label: "a", text: "\\begin{itemize}" },
          { label: "b", text: "\\begin{enumerate}", correct: true },
          { label: "c", text: "\\begin{list}" },
        ],
        explanation:
          "enumerate membuat daftar bernomor (1,2,3...), sedangkan itemize membuat bullet points.",
      },
      {
        question:
          "Package yang paling umum digunakan untuk menambahkan gambar di LaTeX adalah...",
        options: [
          { label: "a", text: "\\usepackage{graphicx}", correct: true },
          { label: "b", text: "\\usepackage{images}" },
          { label: "c", text: "\\usepackage{pictures}" },
        ],
        explanation:
          "Package graphicx menyediakan perintah \\includegraphics untuk memasukkan gambar.",
      },
      {
        question:
          "Untuk membuat tabel di LaTeX, environment yang digunakan adalah...",
        options: [
          { label: "a", text: "\\begin{table}" },
          { label: "b", text: "\\begin{tabular}", correct: true },
          { label: "c", text: "\\begin{grid}" },
        ],
        explanation:
          "tabular adalah environment utama untuk membuat tabel, sering dibungkus dalam environment table untuk positioning.",
      },
      {
        question:
          "Perintah untuk membuat referensi silang (cross-reference) ke section atau figure adalah...",
        options: [
          { label: "a", text: "\\link dan \\goto" },
          { label: "b", text: "\\label dan \\ref", correct: true },
          { label: "c", text: "\\mark dan \\cite" },
        ],
        explanation:
          "\\label{nama} memberi label pada objek, dan \\ref{nama} merujuk ke nomor objek tersebut secara otomatis.",
      },
    ],
  },
  {
    ...
    subtitle: "Selamat!",
    content: [
      "Anda telah berhasil menyelesaikan sertifikasi ICT.",
